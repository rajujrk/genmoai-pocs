...
import services.genmo.mochi_preview.vae.cp_conv as cp_conv
from services.genmo.lib.progress import get_new_progress_bar, progress_bar
from services.genmo.lib.utils import Timer
from services.genmo.mochi_preview.vae.models import (
    Decoder,
    decode_latents,
    decode_latents_tiled_full,
    decode_latents_tiled_spatial,
)
from services.genmo.mochi_preview.vae.vae_stats import dit_latents_to_vae_latents
...
class DitModelFactory(ModelFactory):
    ...
    def get_model(self, *, local_rank, device_id, world_size):
        ...
        from services.genmo.mochi_preview.dit.joint_model.asymm_models_joint import (
            AsymmDiTJoint,
        )
